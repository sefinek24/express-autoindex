...
export default () => {
    ...
    const generalError = new Map([
        ...
        ['ENAMETOOLONG', { message: STATUS_CODES[414], httpCode: 414 }],
        ...
        ['ETIMEDOUT', { message: STATUS_CODES[408], httpCode: 408 }]
    ]);
    const ret = new Map([...statErrors, ...generalError]);
    ret.forEach((e, key) => {
        if (!e.httpCode)
